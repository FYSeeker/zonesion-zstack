...
* 宏定义
*********************************************************************************************/
#define    SCL	                P0_4       	                	//IIC时钟引脚定义
#define    SDA	                P0_5       	                	//IIC数据引脚定义

#define    SDA_IN               (P0DIR &= ~0x20)
#define    SDA_OUT              (P0DIR |= 0x20)
/*********************************************************************************************
* 名称：iic_delay_us()
* 功能：延时函数
* 参数：i -- 延时设置
...
void iic2_init(void)
{
  P0SEL &= ~0x30;                                              	//设置P0_4/P0_5为普通IO模式
  P0DIR |= 0x30;                                                //设置P0_4/P0_5为输出模式
  SDA = 1;                                                      //拉高数据线
  SCL = 1;                                                      //拉高时钟线
