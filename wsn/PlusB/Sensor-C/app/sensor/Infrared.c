...
void infrared_init(void)
{
  ...
  RCC_AHB1PeriphClockCmd(INFRARED_RCC, ENABLE);                 //开启人体红外相关的GPIO外设时钟
  
  GPIO_InitStructure.GPIO_Pin = INFRARED_PIN;                   //选择要控制的GPIO引脚
  ...
  GPIO_Init(INFRARED_GPIO, &GPIO_InitStructure);                //初始化GPIO配置
}
